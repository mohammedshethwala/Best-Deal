...
//Code for Smartphones		
		...
		{
			out.println("<article><h3>"+companyType+" Smartphones</h3></article>");
...
//Code for Tablets		
		...
		{
			out.println("<article><h3>"+companyType+" Tablets</h3></article>");
			out.println("<article class=\"expanded\">");
...
//Code for tv's
		...
		{
			out.println("<article><h3>"+companyType+" Televisions</h3></article>");
			out.println("<article class=\"expanded\">");
