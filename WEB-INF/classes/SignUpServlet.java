...
public class SignUpServlet extends HttpServlet
{
	...
	if(password.equals(rePassword) && firstName != "" && lastName != "" && emailId != "" && phoneNumber != "" && password != "" && rePassword != "")
	{
		...
		else
		{
			...
			out.println("<header><h1><a href=\"/\">Best<span>Deal</span></a></h1><h2>Best Price Guaranteed</h2></header>");
			out.println("<h3 align=\"center\">Customer Login</h3>");
			out.println("<fieldset>");
			out.println("<div style=\"width:400px; margin-right:auto; margin-left:auto;\">");
			out.println("<form action=\"/assignment5/LoginServlet\" method=\"POST\">");
		...
		*/
		/*
		out.println("<!doctype html><html><head><meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\" /><title>Best Deal</title>");
