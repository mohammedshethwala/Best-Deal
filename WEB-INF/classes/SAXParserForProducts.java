...
public class SAXParserForProducts extends DefaultHandler {
    ...
    String smartphonesXmlFileName = "C:/apache-tomcat-7.0.34/webapps/assignment5/WEB-INF/classes/SmartphoneCatalog.xml";
	String tabletsXmlFileName = "C:/apache-tomcat-7.0.34/webapps/assignment5/WEB-INF/classes/TabletCatalog.xml";
	String laptopsXmlFileName = "C:/apache-tomcat-7.0.34/webapps/assignment5/WEB-INF/classes/LaptopCatalog.xml";
	String televisionsXmlFileName = "C:/apache-tomcat-7.0.34/webapps/assignment5/WEB-INF/classes/TelevisionCatalog.xml";
	String accessoriesXmlFileName = "C:/apache-tomcat-7.0.34/webapps/assignment5/WEB-INF/classes/AccessoryCatalog.xml";
...
//Fetching values of smartphones
        ...
        if (element.equalsIgnoreCase("smartPhoneImage")) {
            smartphone.setImage(elementValueRead);
		
	    return;
        }
        if (element.equalsIgnoreCase("smartPhoneName")) {
            smartphone.setName(elementValueRead);
			
	    return;
        }
		if (element.equalsIgnoreCase("smartPhoneCompany")) {
            smartphone.setCompany(elementValueRead);
			
	    return;
        }
		if (element.equalsIgnoreCase("smartPhoneCondition")) {
            smartphone.setCondition(elementValueRead);
			
	    return;
        }
		if(element.equalsIgnoreCase("smartPhonePrice")){
            smartphone.setPrice(Float.parseFloat(elementValueRead));
			
	    return;
        }
        if(element.equalsIgnoreCase("smartPhoneColor")){
           smartphone.setColor(elementValueRead);
		  
	    return;
        }
		if(element.equalsIgnoreCase("smartPhoneDescription")){
